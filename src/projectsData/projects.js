...
const projects = [
  {
    ...
    description:
      'Full stack web app for renting exotic cars. Created API with Ruby on Rails, database with PostgreSQL, frontend with React. Users can rent cars, admins can add and delete cars.',
  ...
  },
  {
    ...
    description:
      'Interactive to do list built with react. It lets you add tasks, check them, and edit them. It uses local storage to store the values of the user data.',
  ...
  },
  {
    ...
    description:
      'A webpage for using a simple calculator made with React. Navbar for displaying three different routes.',
    languages: ['HTML', 'CSS', 'Javascript', 'React'],
  ...
  },
  {
    ...
    description:
      'In this project I built a webpage where the user can search for different TV shows, comment them and like them, using TVmaze and Involvement APIs.',
  ...
  },
  {
    ...
    description:
      'Bookstore is a SPA that lets you display a list of books, add and, remove them, using an API.',
    languages: ['HTML', 'CSS', 'Javascript', 'React/Redux'],
